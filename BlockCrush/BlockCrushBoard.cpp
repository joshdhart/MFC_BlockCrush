...
void CBlockCrushBoard::SetupBoard(void)
{
...
COLORREF CBlockCrushBoard::GetBoardSpace(int row, int col)
{
...
void CBlockCrushBoard::DeleteBoard(void)
{
...
void CBlockCrushBoard::CreateBoard(void)
{
...
int CBlockCrushBoard::DeleteBlocks(int row, int col)
{
...
int CBlockCrushBoard::DeleteNeighborBlocks(int row, int col, int color, Direction direction)
{
...
void CBlockCrushBoard::CompactBoard(void)
{
...
bool CBlockCrushBoard::IsGameOver(void) const
{
